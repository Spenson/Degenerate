...

{
	...
	drawInfo.pVertices = new sComplexVertex[drawInfo.numberOfVertices];
...
//	glBindBuffer(GL_ARRAY_BUFFER, vertex_buffer);
	...
	glBufferData( GL_ARRAY_BUFFER, 
				  sizeof(sComplexVertex) * drawInfo.numberOfVertices,	// ::g_NumberOfVertsToDraw,	// sizeof(vertices), 
