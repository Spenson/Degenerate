...
MyPhysics::cWorld::~cWorld()
{
}

glm::vec3 MyPhysics::cWorld::GetGravity()
{
	return mGravity;
}

void MyPhysics::cWorld::SetGravity(const glm::vec3& newGravity)
{
	mGravity = newGravity;
}

void MyPhysics::cWorld::IntegrateRigidBody(cRigidBody* body, float dt)
{
...
void MyPhysics::cWorld::Update(float dt)
{
...
bool MyPhysics::cWorld::AddRigidBody(cRigidBody* rigidBody)
{
...
bool MyPhysics::cWorld::RemoveRigidBody(cRigidBody* rigidBody)
{
	if (!rigidBody) return false;
	std::vector<cRigidBody*>::iterator itBody = std::find(mBodies.begin(), mBodies.end(), rigidBody);
...
bool MyPhysics::cWorld::Collide(cRigidBody* bodyA, cRigidBody* bodyB)
{
...
bool MyPhysics::cWorld::CollideSpherePlane(cRigidBody* sphereBody, cSphere* sphereShape, cRigidBody* planeBody, cPlane* planeShape)
{
...
bool MyPhysics::cWorld::CollideSphereSphere(cRigidBody* bodyA, cSphere* shapeA, cRigidBody* bodyB, cSphere* shapeB)
{
